...
export default function TermsOfService(){
    ...
    return <div className="terms-of-service">
        ...
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Mine Grinder.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Material</strong> refers to content displayed on the website including but not limited to logos, images, text, etc.</p>
        </li>
        <li>
        ...
        <h2>Material Use and Copyright</h2>
